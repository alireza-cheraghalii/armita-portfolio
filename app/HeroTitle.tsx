...
export default function HeroTitle() {
    return (
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 mt-4 mb-6">
            ...
            {/* Main Heading */}
            <h1 className="font-poppins font-semibold text-4xl sm:text-5xl md:text-[56px] leading-[1.1] tracking-tight text-white">
          ...
          {/* Doodle: 3 Curved Lines (Left of "UI") */}
                    <div className="absolute -left-12 -bottom-10 sm:-left-10 sm:top-11 w-10 sm:w-14 opacity-90">
