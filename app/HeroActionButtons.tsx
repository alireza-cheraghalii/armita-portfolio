...
export default function HeroActionButtons() {
    return (
        <div className="relative inline-flex items-center justify-center mt-8 md:mt-12 mb-8">
            ...
            {/* --- Doodles (Only visible on Desktop/Tablet to prevent overflow) --- */}
            ...
            <div
                className="flex items-center p-1.5 md:p-2 bg-[#1A1A1A]/90 backdrop-blur-md border border-white/5 rounded-full shadow-2xl">

                {/* Portfolio Link/Button */}
                <a href="#portfolio"
                   className="px-6 py-2 md:px-8 md:py-3 text-lg md:text-2xl font-medium text-white/90 hover:text-white transition-colors">
                    Portfolio
                </a>

                {/* Hire Me Button */}
                <a href="#contact"
                   className="group flex items-center gap-2 md:gap-3 px-6 py-2 md:px-8 md:py-3 bg-[#5B6CFF] hover:bg-[#4a5ae0] text-white rounded-full transition-all duration-300 shadow-lg shadow-indigo-500/20">
                    <span className="text-lg md:text-2xl font-medium">Hire me</span>
